...
LOG_SEPARATOR = "=" * 80
LOG_INITIALIZED_FLAG = f"_{APP_SLUG}_initialized"
...
def init_logging() -> Path:
    """Configure console, file, stream, warning, and exception logging."""
    log_file_path = LOG_FILE_PATH
    if getattr(logger, LOG_INITIALIZED_FLAG, False):
    ...
    setattr(logger, LOG_INITIALIZED_FLAG, True)
    return log_file_path
# --------------------------------------------------------------------------------------------------
